          ...
          <div>
            ...
            {user._id === newUser._id ? (
              <div
                ...
                className="absolute flex items-center 2xl:top-[440px] top-[413px] bg-blue-600 text-white px-3 py-1 text-lg cursor-pointer right-5 md:right-10 lg:right-14 2xl:right-80"
              >
